...
func NewCoin(index int64, value hcashutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 1.29994545HCASH value.
	...
	testSimpleCoinTxValue0            = hcashutil.Amount(129994545)
	...
	testSimpleCoinTx, _               = hcashutil.NewTxFromBytes(testSimpleCoinTxBytes)
