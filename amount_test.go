...
func TestAmountMulF64(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Multiply 0.1 HCASH by 2",
			amt:  100e5, // 0.1 HCASH
			mul:  2,
			res:  200e5, // 0.2 HCASH
		},
		{
			name: "Multiply 0.2 HCASH by 0.02",
			amt:  200e5, // 0.2 HCASH
			mul:  1.02,
			res:  204e5, // 0.204 HCASH
		},
		{
			name: "Multiply 0.1 HCASH by -2",
			amt:  100e5, // 0.1 HCASH
