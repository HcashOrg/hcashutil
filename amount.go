...
// units, "1eN HCASH" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " HCASH"
	}
}
...
//
// NewAmount is for specifically for converting HCASH to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/HcashOrg/hcashutil#example-Amount
...
// useful for services that build on top of hypercash (for example, calculating
