...
The modified base58 alphabet used by Hypercash, and hence this package,
omits the 0, O, I, and l characters that look the same in many fonts
and are therefore hard to humans to distinguish.

Base58Check Encoding Scheme

The Base58Check encoding scheme is primarily used for Hypercash addresses at the
time of this writing, however it can be used to generically encode arbitrary
byte arrays into human-readable strings along with a version byte that can be
used to differentiate the same payload.  For Hypercash addresses, the extra
