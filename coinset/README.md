...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/HcashOrg/hcashutil/coinset)

Package coinset provides hypercash-specific convenience functions for selecting
...
```bash
$ go get -u github.com/HcashOrg/hcashutil/coinset
```
...
The typical use case for this library is for creating raw hypercash transactions
